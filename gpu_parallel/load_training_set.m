...
score_matx= gpuArray.zeros(num_user , num_movie, 'single');
...
ones_matrix = gpuArray.ones(num_user, num_movie, 'single');
valued_matx = gpuArray(single((ones_matrix & score_matx)'));
